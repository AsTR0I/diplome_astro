...
import { t as throwException, g as getException, c as createYmapsOptions, i as initYmaps, V as VueYandexMaps, s as setFragment, a as copy, e as excludeKeys, h as hVue2, b as hF, d as getAttrsForVueVersion, f as sleep, j as isVue2 } from "./vue-yandex-maps-BD41h_Ro.js";
import { getCurrentInstance, watch, inject, isRef, defineComponent, shallowRef, ref, provide, computed, onMounted, onBeforeUnmount, nextTick, h, onUpdated, triggerRef } from "vue";
...
const _sfc_main$6 = defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    return () => {
      let clusterSlots;
      if (isVue2()) {
        clusterSlots = features.value.map((feature) => h(_sfc_main$7, {
          props: {
...
export {
  VueYandexMaps,
  _sfc_main$s as YandexMap,
  _sfc_main$b as YandexMapCartesianProjection,
  _sfc_main$5 as YandexMapClusterer,
  _sfc_main$4 as YandexMapCollection,
  _sfc_main$g as YandexMapControl,
  _sfc_main$f as YandexMapControlButton,
  _sfc_main$h as YandexMapControls,
  _sfc_main$q as YandexMapDefaultFeaturesLayer,
  _sfc_main$j as YandexMapDefaultMarker,
  _sfc_main$o as YandexMapDefaultSatelliteLayer,
  _sfc_main$p as YandexMapDefaultSchemeLayer,
  _sfc_main$3 as YandexMapEntity,
  _sfc_main$i as YandexMapFeature,
  _sfc_main$m as YandexMapFeatureDataSource,
  _sfc_main$e as YandexMapGeolocationControl,
  _sfc_main$9 as YandexMapHint,
  _sfc_main$l as YandexMapLayer,
  _sfc_main$r as YandexMapListener,
  _sfc_main$k as YandexMapMarker,
  _sfc_main$8 as YandexMapOpenMapsButton,
  _sfc_main$2 as YandexMapRuler,
  _sfc_main$c as YandexMapScaleControl,
  _sfc_main$a as YandexMapSphericalMercatorProjection,
  _sfc_main$n as YandexMapTileDataSource,
  _sfc_main as YandexMapTrafficEventsLayer,
  _sfc_main$1 as YandexMapTrafficLayer,
  _sfc_main$d as YandexMapZoomControl,
  createYmaps,
  createYmapsOptions,
  createYmapsVue2,
  getBoundsFromCoords,
